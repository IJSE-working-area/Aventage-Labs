    ...
    return (
        <div id='navigationset' className='bg-dark col-auto col-md-2 min-vh-100'>
            ...
            <ul className='nav nav-pills flex-column'>
                ...
                <li className='nav-item text-white fs-6'>
                    <Link className='nav-link text-white text-decoration-none' to="/NewOrder">New order</Link>
                </li>
                <li className='nav-item text-white fs-6'>
                    <Link className='nav-link text-white text-decoration-none' to="/Reports">Reports</Link>
                </li>
                <li className='nav-item text-white fs-6'>
